...
// source: bla/sentence.proto

#define INTERNAL_SUPPRESS_PROTOBUF_FIELD_DEPRECATION
#include "bla/sentence.pb.h"
...
void protobuf_ShutdownFile_bla_2fsentence_2eproto() {
  delete Sentence::default_instance_;
  delete Token::default_instance_;
}

#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
void protobuf_AddDesc_bla_2fsentence_2eproto_impl() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

#else
void protobuf_AddDesc_bla_2fsentence_2eproto() GOOGLE_ATTRIBUTE_COLD;
void protobuf_AddDesc_bla_2fsentence_2eproto() {
  ...
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_bla_2fsentence_2eproto);
}

#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
GOOGLE_PROTOBUF_DECLARE_ONCE(protobuf_AddDesc_bla_2fsentence_2eproto_once_);
void protobuf_AddDesc_bla_2fsentence_2eproto() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AddDesc_bla_2fsentence_2eproto_once_,
                 &protobuf_AddDesc_bla_2fsentence_2eproto_impl);
}
#else
// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_bla_2fsentence_2eproto {
  StaticDescriptorInitializer_bla_2fsentence_2eproto() {
    protobuf_AddDesc_bla_2fsentence_2eproto();
  }
} static_descriptor_initializer_bla_2fsentence_2eproto_;
#endif
...
const Sentence& Sentence::default_instance() {
  ...
  protobuf_AddDesc_bla_2fsentence_2eproto();
#else
  if (default_instance_ == NULL) protobuf_AddDesc_bla_2fsentence_2eproto();
#endif
